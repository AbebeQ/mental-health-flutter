...
class Question extends StatefulWidget {
  const Question(this.question, this.qno, this.disorder, this.colors, {super.key});
...
class _QuestionState extends State<Question> {
  ...
  bool over = false;
  int totalScore = 0;
  List<int> answers = List.filled(11, -1); // Initialize with -1 indicating no answer

  Future sendEmail(String name1, String name2, String message, String email) async {
    final url = Uri.parse('https://https://dashboard.emailjs.com/admin/account/v1.0/email/send');
      ...
      children: [
        ...
        over == false
          ...
          children: [
            ...
            SizedBox(height: 20),
            ElevatedButton(
              onPressed: i < widget.qno - 1 ? null : () {
                setState(() {
                  over = true;
                });
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: i < widget.qno - 1 ? Colors.grey : Colors.blue,
        ...
        over == true
          ...
          children: [
            const Text(
              'Please focus on yourself and give yourself some time to communicate experts.',
              textAlign: TextAlign.center,
