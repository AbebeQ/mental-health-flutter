...
import 'package:mwntalassessment/Assessment.dart';
            ...
            Column(
              ...
              children: [
                ListTile(
                  title: Center(
                    child: Text(
                      conclusion['conclusion']?.replaceAll('_', ' ') ?? 'Condition not found',
                      style: TextStyle(
                        fontSize: 30.0,
                  ...
                  subtitle: Text(
                    conclusion['definition'] ?? 'Definition not available',
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Column(
                            children: List<String>.from(conclusion['conditions']).map((condition) {
                              return Padding(
