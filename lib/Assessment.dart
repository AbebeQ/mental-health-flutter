...
import 'package:mwntalassessment/QuizPage.dart';
  ...
  void navigateToQuiz(String conclusion) {
    if (conclusion == 'Depression') {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(depression, 11, 'Depression', [Colors.blue, Colors.greenAccent]),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(anxiety, 11, 'Anxiety', [Colors.red, Colors.pinkAccent]),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(grief, 11, 'Grief', [Colors.grey, Colors.blueGrey]),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(ptsd, 11, 'Post-Traumatic Stress Disorder', [Colors.deepPurple, Colors.purpleAccent]),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(schizophrenia, 11, 'Schizophrenia', [Colors.purple, Colors.indigo]),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(psychosisQuestions, 11, 'Psychosis', [Colors.brown, Colors.deepOrange]),
        ),
      );
    } else if (conclusion == 'Eating_disorder') {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(eatingDisorder, 11, 'Eating Disorder', [Colors.amber, Colors.deepOrangeAccent]),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(bipolarDisorder, 11, 'Bipolar Disorder', [Colors.pink, Colors.pinkAccent]),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(addiction, 11, 'Addiction', [Colors.cyan, Colors.lightBlueAccent]),
        ),
      );
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => QuizPage(epilepsy, 11, 'Epilepsy', [Colors.deepOrange, Colors.deepOrangeAccent]),
        ),
      );
    } else {
